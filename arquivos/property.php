        ...
        if(isset($_GET['id'])) {
            ...
            try {
                ...
                if($stmt->rowCount() > 0) {
                    ...
                    echo "<center><h1>Informações do Imóvel</h1></center>";
                    echo "<br>";
                    echo "<center><p>Cidade: {$imovel['cidade']}</p></center>";
                    echo "<center><p>Endereço: {$imovel['endereco']}</p></center>";
                    echo "<center><p>Categoria: {$imovel['categoria']}</p></center>";
                    echo "<center><p>Preço: R$ {$imovel['preco']}</p></center>";
                    echo "<center><p>Status: {$imovel['status']}</p></center>";
                    // Exibe a imagem do imóvel
                    echo "<center><img src='../php/{$imovel['foto']}' alt='{$imovel['foto']}' width='300'></center>";
                } else {
